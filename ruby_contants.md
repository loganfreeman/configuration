...
puts Animal.ancestors # [Animal, Walkable, Object, Kernel, BasicObject]
```
Ruby first looked for the walk instance method in Animal, and not finding it there, kept looking in the next place according to our `ancestors`, which is the Walkable module. It saw a walk method there, executed it, and stopped looking further.
